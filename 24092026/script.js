...
/* Whatsapp Icon */
const waNumber = "919745397722"; // country code + number, no + or spaces

const shareMsg = "സായാഹ്ന വാർത്ത – ഇന്നത്തെ പതിപ്പ് വായിക്കാം: " + location.href;
const chatMsg = "നമസ്കാരം, സായാഹ്ന വാർത്തയിലേക്ക് ഒരു വാർത്ത / പരസ്യം സംബന്ധിച്ച് അറിയിക്കാനുണ്ട്.";

document.getElementById("waShare").href =
    "https://wa.me/?text=" + encodeURIComponent(shareMsg);
document.getElementById("waChat").href =
    "https://wa.me/" + waNumber + "?text=" + encodeURIComponent(chatMsg);
/*
    ----------------------------------------
    START E-PAPER
    ----------------------------------------
